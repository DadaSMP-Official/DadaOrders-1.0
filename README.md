...
**DadaOrders 1.0** is a custom Minecraft plugin for Paper/Spigot servers.
...
| Main class | `it.dadasmp.orders.DadaOrders` |
...
| --- | --- | --- |
| `dadaorders.use` | `true` | Permission node. |
| `dadaorders.admin` | `op` | Permission node. |
| `dadaorders.reload` | `op` | Permission node. |
| `dadaorders.limit.1` | `true` | Permission node. |
| `dadaorders.limit.3` | `false` | Permission node. |
| `dadaorders.limit.5` | `false` | Permission node. |
| `dadaorders.limit.8` | `false` | Permission node. |
| `dadaorders.limit.12` | `false` | Permission node. |
| `dadaorders.limit.20` | `false` | Permission node. |
